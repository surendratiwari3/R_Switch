...
<ul class="breadcrumb">
    ...
    <li><a href="javascript:;">Manage Buy Call Rates</a></li>
</ul>
...
<div class="row-fluid sortable ui-sortable">		
    <div class="box span12">
        <div class="box-header">
            <h2><i class="icon-rss"></i><span class="break"></span>Manage Buy Call Rates</h2>
            <h2 class="box-icon">
        ...
        <div class="span5">
            ...
            <div class="span4 pull-right">
             <?php
                echo CHtml::Link('<i class="icon-download">Import Buy Rates</i>', array("buyCallRates/import"), array(
                    "title" => "Import",
                    "class" => "btn btn-success importRecord"
                ));
                ?>
               <?php
                echo CHtml::Link('<i class="icon-file">Download Sample</i>', "did_master.csv", array(
                    "title" => "Sample File",
                    "class" => "btn btn-blue"
                ));
                ?>
			...
			'pulse_rate',
			'pulse_duration',
			'rate_card_id' => array('value' =>'$data->ratecardRelation->ratecard_name','name'=>'RateCard Name'),
			array(
                        'value' => '($data->rate_status=="1")?"ACTIVE":"INACTIVE"',
                        'name'  => 'Rate Status',
                        ),
                        array(
                            "class" => "CButtonColumn",
                            ...
                            "buttons" => array(
                                "updateRecord" => array(
                                    ...
                                    "imageUrl" => false,
                                    "url" => 'Yii::app()->createUrl("buyCallRates/update", array("id"=>$data->buy_call_rates_id))',
                                ...
                                "deleteRecord" => array(
                                    ...
                                    "imageUrl" => false,
                                    "url" => 'Yii::app()->createUrl("buyCallRates/delete", array("id"=>$data->buy_call_rates_id))',
                ...
                Yii::app()->clientScript->registerScript('actions', "
                    $('.deleteRecord').live('click',function() {
                     ...
                     $('.importRecord').live('click',function() {                        
                        ...
                        $.post('" . Yii::app()->createUrl("buyCallRates/import") . "',function(html){
