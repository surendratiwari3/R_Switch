...
/* @var $data SellCallRates */
?>

<div class="view">

	<b><?php echo CHtml::encode($data->getAttributeLabel('sell_call_rates_id')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->sell_call_rates_id), array('view', 'id'=>$data->sell_call_rates_id)); ?>
	<br />
