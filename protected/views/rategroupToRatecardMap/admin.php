<ul class="breadcrumb">
    ...
    <li><a href="javascript:;">rategroupToRatecardMap</a></li>
</ul>
...
<div class="row-fluid sortable ui-sortable">		
    <div class="box span12">
        <div class="box-header">
            <h2><i class="icon-rss"></i><span class="break"></span>RateGroup RateCard Mapping</h2>
            <h2 class="box-icon">
                <a style="margin-top:-9px;" title="Create Did Subscription" href="<?php echo Yii::app()->createUrl(Yii::app()->controller->id . "/create"); ?>">
                    ...
                    Create RateGroup RateCard Mapping
                </a>
            </h2>
        </div>
                        ...
                        array(
                            ...
                            "buttons" => array(
                                "updateRecord" => array(
                                    ...
                                    "imageUrl" => false,
                                    "url" => 'Yii::app()->createUrl("rategroupToRatecardMap/update", array("id"=>$data->rategroup_to_ratecard_map_id))',
                                ...
                                "deleteRecord" => array(
                                    ...
                                    "imageUrl" => false,
                                    "url" => 'Yii::app()->createUrl("rategroupToRatecardMap/delete", array("id"=>$data->rategroup_to_ratecard_map_id))',
